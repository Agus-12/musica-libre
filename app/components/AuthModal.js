...
export default function AuthModal({ onClose }) {
  ...
  const IS = { padding: "12px 14px", borderRadius: 10, border: "1px solid #2a2a3e", background: "#1a1a2e", color: "#fff", fontSize: "1em", outline: "none", width: "100%", boxSizing: "border-box" };
